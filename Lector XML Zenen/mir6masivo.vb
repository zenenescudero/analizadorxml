...
Public Class mir6masivo
            ...
            Try
                ...
                While (texto.Length > 0)
                    ...
                    For y As Integer = 1 To columnas
                        If y = 19 Then  ' esta condicion es para separar el texto esta en la posicion 18 de las columnas
                            Try
    ...
    Public Sub guardar()
        ...
        Try
            coneccion.Open()
            Dim comando As New MySqlCommand("delete from mir6 where username1='" & username & "'", coneccion)
        ...
        Dim agrega As String = "insert into mir6 values("
        ...
        Cursor.Current = Cursors.Default
        MsgBox("Datos guardados..." & Chr(13) & "Registros Guardados: " & consultaruncampo("select count(*) from mir6 where username1='" & username & "'"), MsgBoxStyle.Information, "Trabajo Terminado")
        Me.Close()
    ...
    Private Sub zmmmasivo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Label1.Text = ""
        '  gridtabla.DataSource = consultartabla("select * from mir6 where NO_DOCUMENTO=0")
        Try
